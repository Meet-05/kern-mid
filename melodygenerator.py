...
class MelodyGenerator:
    ...
    def get_name():
        ...
        extension = ".mid"
        name = "Mel" + str(cTime.day + cTime.hour + cTime.minute) + extension
        return name

    def save_melody(self, melody, step_duration=0.25, format="midi", file_name=get_name()):
...
#     mg = MelodyGenerator()
#     obj = Preprocess()
#     seed = obj.getString('deut0569.krn')
